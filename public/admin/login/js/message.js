...
$.extend({
  message: function(options) {
      ...
      //message模版
      if(defaults.type==="success"){  var templateClose=defaults.showClose?'<a class="c-message--close">×</a>':'';
          var template='<div class="c-message messageFadeInDown">'+
              '<i class=" c-message--icon c-message--'+defaults.type+'"></i>'+
              templateClose+
              '<div  class="c-message--tip">'+defaults.message+'&nbsp;&nbsp;&nbsp;&nbsp;'+'<lable id="show"></lable>'+'</div>'+
              '</div>';
      }
